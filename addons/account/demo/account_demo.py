    ...
    def _get_demo_data_attachment(self, template_code):
        return {
            'ir_attachment_in_invoice_1': {
                ...
                'raw': BinaryFile('account/static/demo/in_invoice_yourcompany_demo_1.pdf'),
            },
            'ir_attachment_in_invoice_2': {
                ...
                'res_field': 'invoice_pdf_report_file',
                'raw': BinaryFile('account/static/demo/in_invoice_yourcompany_demo_2.pdf'),
            },
            'ir_attachment_bank_statement_1': {
                ...
                'raw': BinaryFile('account/static/demo/bank_opening_statement.pdf'),
            },
            'ir_attachment_bank_statement_2': {
                ...
                'raw': BinaryFile('account/static/demo/bank_statement_one_month_old.pdf'),
            },
        }
