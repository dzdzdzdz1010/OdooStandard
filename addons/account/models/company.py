...
class ResCompany(models.Model):
    ...
    def _chart_template_selection(self):
        ...
        if self.root_id and self.root_id._existing_accounting():
            template_code = self.chart_template or 'generic_coa'
            return [(code, name) for code, name in selection if code == template_code]
        return selection
