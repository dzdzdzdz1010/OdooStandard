...
class AccountEdiProxyClientUser(models.Model):
    ...
    def _peppol_get_new_documents(self):
        ...
        for edi_user in self:
            ...
            processed_uuid_to_record = edi_user._peppol_process_new_messages(all_messages)
            ...
            if processed_uuid_to_record:
                ...
                edi_user._peppol_post_process_new_messages(processed_uuid_to_record)
        ...
        for uuid, content in messages.items():
            ...
            if content.get('error'):
                ...
                if content['error'].get('code') == 207:
                    move._message_log(body=self.env._("Peppol error: The recipient does not accept this type of document."))
                else:
