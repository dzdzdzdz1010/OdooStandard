...
class PeppolRejectionWizard(models.TransientModel):
    ...
    def button_send(self):
        ...
        for company in moves_by_company:
            edi_user = company.account_edi_proxy_client_ids.filtered(lambda u: u.proxy_type == 'peppol')
            edi_user._peppol_send_response(moves_by_company[company], 'RE', clarifications)
