...
import { Component, onWillUpdateProps, useEffect } from "@odoo/owl";
 ...
 * this component "activityIds" props refers to the current user activities for a specific date.
 */
export class AttendeeCalendarActivityListPopover extends Component {
    ...
    setup() {
        ...
        useEffect(
            ...
            (populated, activityCount) => {
                if (populated && !activityCount) {
                    this.props.close();
                }
            },
            () => [this.populated, this.allActivities.length]
        );
    }
