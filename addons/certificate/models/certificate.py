...
from odoo.tools import BinaryValue, parse_version
                ...
                if key:
                    ...
                    if not key_id:
                        key_id = self.env['certificate.key'].create({
                            ...
                            'content': BinaryValue.from_bytes(pem_key),
    ...
    def _compute_pem_certificate(self):
        for certificate in self:
            ...
            if not content:
                ...
                certificate.pem_certificate = BinaryValue.from_bytes(cert.public_bytes(Encoding.PEM))
