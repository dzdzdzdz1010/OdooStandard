...
class HrLeave(models.Model):
    ...
    def _compute_has_mandatory_day(self):
        ...
        if date_from and date_to:
            ...
            for leave in self:
                ...
                if leave.work_entry_type_id.company_id:
                    domain += [('company_id', '=', leave.work_entry_type_id.company_id.id)]
    ...
    def _get_durations(self, check_work_entry_type=True, resource_calendar=None, additional_domain=[]):
        """
    ...
    def _get_redirect_suggested_company(self):
        return self.work_entry_type_id.company_id
