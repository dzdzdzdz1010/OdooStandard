...
class HrLeaveAllocation(models.Model):
    ...
    accrual_plan_id = fields.Many2one('hr.leave.accrual.plan',
        compute="_compute_accrual_plan_id", inverse="_inverse_accrual_plan_id", store=True, index='btree_not_null', tracking=True,
    ...
    def _get_title(self):
        ...
        if self.type_request_unit == 'hour':
            return _(
                ...
                duration=float_round(self.number_of_days * self._get_employee_hours_per_day(), precision_digits=2),
            )
        return _(
        ...
        for allocation in self:
            ...
            while allocation.nextcall <= date_to:
                ...
                if current_level.accrual_validity or allocation._has_expiring_days():
                    ...
                    if allocation._has_expiring_days():
