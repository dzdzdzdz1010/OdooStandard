...
class HrLeaveType(models.Model):
    ...
    def get_leave_types_with_valid_allocations(self, date_from, date_to, employee_id):
    ...
    def _compute_valid(self):
        ...
        valid_types = self.get_leave_types_with_valid_allocations(date_from, date_to, employee_id)
        (self - valid_types).has_valid_allocation = False
