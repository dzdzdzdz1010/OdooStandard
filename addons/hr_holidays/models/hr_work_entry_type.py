...
class HrWorkEntryType(models.Model):
    ...
    icon_id = fields.Many2one('ir.attachment', string='Cover Image', domain="[('res_model', '=', 'hr.work.entry.type'), ('res_field', '=', 'icon_id')]")
            ...
            for work_entry_type in self:
                lt_info = (
                    work_entry_type.name,
                    {
                        ...
                        'icon': work_entry_type.sudo().icon_id.url,
