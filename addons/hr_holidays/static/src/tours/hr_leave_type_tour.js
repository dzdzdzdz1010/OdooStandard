...
const WorkEntryType1 = "work_entry_type_1";
const WorkEntryType2 = "work_entry_type_2";
const WorkEntryType3 = "work_entry_type_3";
...
registry.category("web_tour.tours").add("hr_work_entry_type_tour", {
    url: "/web",
    steps: () => [
        ...
        // Check if a time-off could be requested using work_entry_type_1 as company_1 is selected by default.
        {
            trigger: 'div[name="work_entry_type_id"] input',
            content: "Create a time-off using work_entry_type_1. Select it from the list",
            tooltipPosition: "bottom",
            run: `edit ${WorkEntryType1}`,
        },
        {
            isActive: ["auto"],
            trigger: `.ui-autocomplete .ui-menu-item a:contains("${WorkEntryType1}")`,
            run: "click",
        },
        {
            trigger: `.o_field_widget[name='work_entry_type_id'] input:value("${WorkEntryType1}")`,
        },
        // Check that a time-off cannot be requested using work_entry_type_2 as company_2 is not selected.
        {
            trigger: 'div[name="work_entry_type_id"] input',
            content: "Try to select work_entry_type_2 from the list. It shouldn't be present",
            tooltipPosition: "bottom",
            run: `edit ${WorkEntryType2}`,
        },
        {
            trigger: `.ui-autocomplete .ui-menu-item span:contains('${noRecords}')`,
        },
        // Check if a time-off could be requested using work_entry_type_3
        {
            trigger: 'div[name="work_entry_type_id"] input',
            content: "Select work_entry_type_3 from the list",
            tooltipPosition: "bottom",
            run: `edit ${WorkEntryType3}`,
        },
        {
            isActive: ["auto"],
            trigger: `.ui-autocomplete .ui-menu-item a:contains("${WorkEntryType3}")`,
            run: "click",
        },
        {
            trigger: `.o_field_widget[name='work_entry_type_id'] input:value("${WorkEntryType3}")`,
        },
        {
        ...
        },
        {
            trigger: 'div[name="work_entry_type_id"] input',
            content:
                "Select work_entry_type_2 from the list. It should be available now because company_2 is selected",
            tooltipPosition: "bottom",
            run: `edit ${WorkEntryType2}`,
        },
        {
            isActive: ["auto"],
            trigger: `.ui-autocomplete .ui-menu-item a:contains("${WorkEntryType2}")`,
            run: "click",
        },
        {
            trigger: `.o_field_widget[name='work_entry_type_id'] input:value("${WorkEntryType2}")`,
            tooltipPosition: "bottom",
        },
        {
            trigger: "div[name=request_date_from] button",
