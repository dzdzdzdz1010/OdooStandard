...
class HrLeaveAllocation(models.Model):
    ...
    def _compute_employee_overtime(self):
        diff_by_employee = self.employee_id._get_deductible_employee_overtime(self.employee_id)
        for allocation in self:
            allocation.employee_overtime = diff_by_employee[allocation.employee_id]

    @api.model_create_multi
    def create(self, vals_list):
        res = super().create(vals_list)
        deductible = res.employee_id._get_deductible_employee_overtime(res.employee_id)
    ...
    def write(self, vals):
        ...
        deductible = self.employee_id._get_deductible_employee_overtime(self.employee_id)
