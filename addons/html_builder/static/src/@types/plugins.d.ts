declare module "plugins" {
    ...
    import { editor_enabled_handlers, hidden_element_predicates, lower_panel_entries, on_mobile_preview_clicked, trigger_dom_updated } from "@html_builder/builder";
    ...
    import { is_movable_selector, MoveShared } from "@html_builder/core/move_plugin";
    ...
    export interface BuilderResourcesList {
        ...
        editor_enabled_handlers: editor_enabled_handlers;
        ...
        reveal_target_handlers: reveal_target_handlers;
        ...
        hidden_element_predicates: hidden_element_predicates;
        is_draggable_handlers: is_draggable_handlers;
        keep_overlay_options: keep_overlay_options;

        // Processors
        reveal_target_destination_processors: reveal_target_destination_processors;
