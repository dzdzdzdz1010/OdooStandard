...
export class DisableSnippetsPlugin extends Plugin {
    ...
    resources = {
        on_removed_listeners: this.disableUndroppableSnippets.bind(this),
        post_undo_listeners: this.disableUndroppableSnippets.bind(this),
        post_redo_listeners: this.disableUndroppableSnippets.bind(this),
