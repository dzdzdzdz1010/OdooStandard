...
export class SavePlugin extends Plugin {
    ...
    static shared = ["save", "saveView", "ignoreDirty", "groupElement"];
    ...
    groupElement(toGroupEls) {
        return groupBy(toGroupEls, (dirtyEl) => {
    ...
    async _save() {
        ...
        const groupedElements = this.groupElement(dirtyEls);
