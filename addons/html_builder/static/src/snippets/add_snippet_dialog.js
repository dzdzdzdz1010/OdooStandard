...
/**
 * @typedef {((arg: { iframe: HTMLIFrameElement }) => void)[]} snippet_preview_dialog_stylesheets_listeners
...
export class AddSnippetDialog extends Component {
    ...
    async insertStyle() {
        ...
        this.props.editor.trigger("snippet_preview_dialog_stylesheets_listeners", {
