...
test("should correctly set custom style on link", async () => {
    await setupHTMLBuilder('<p><a href="https://test.com/">Link label</a></p>');
...
test("border works even if current border style is none", async () => {
    await setupHTMLBuilder('<p><a href="http://test.com/">Link label</a></p>', {
