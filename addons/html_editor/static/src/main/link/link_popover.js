...
export class LinkPopover extends Component {
    ...
    setup() {
        ...
        this.state = useState({
            ...
            linkPreviewName: "",
            imgSrc: "",
            type: this.props.type || this.props.linkStylePlugin.getType(linkElement),
            linkTarget: linkElement.target === "_blank" ? "_blank" : "",
            directDownload: true,
            isDocument: false,
            buttonSize: this.props.linkStylePlugin.getSize(linkElement),
            buttonShape: this.props.linkStylePlugin.getShape(linkElement),
    ...
    get classes() {
        return this.props.linkStylePlugin.computeClasses(this.props.linkElement, {
