...
/**
 * @typedef { Object } LinkStyleShared
 * @property { LinkStylePlugin['getTypesData'] } getTypesData
 * @property { LinkStylePlugin['getShapesData'] } getShapesData
 * @property { LinkStylePlugin['getSizesData'] } getSizesData
 * @property { LinkStylePlugin['computeClasses'] } computeClasses
 * @property { LinkStylePlugin['getType'] } getType
 * @property { LinkStylePlugin['getSize'] } getSize
 * @property { LinkStylePlugin['getShape'] } getShape
 */

export class LinkStylePlugin extends Plugin {
    static id = "linkStyle";
    static dependencies = [];
    static shared = [
        "getTypesData",
    ...
    computeClasses(el, { type, size, shape }) {
    ...
    getShape(el) {
        ...
        let shapeMatched = "";
        let matchScore = 0;
        for (const { shape } of this.getShapesData()) {
            if (!shape) {
                continue;
            }
