 ...
 * @typedef {((movableElement: HTMLElement) => void)[]} set_movable_element_listeners
 * @typedef {(() => void)[]} unset_movable_element_listeners
 */
...
export class MoveNodePlugin extends Plugin {
    ...
    resources = {
        layout_geometry_change_listeners: () => {
    ...
    setMovableElement(movableElement) {
        ...
        this.trigger("set_movable_element_listeners", movableElement);
    ...
    removeMoveWidget() {
        this.trigger("unset_movable_element_listeners");
