...
export class PowerButtonsPlugin extends Plugin {
    ...
    createPowerButtons() {
        ...
        this.powerButtonsContainer.className = `o_we_power_buttons d-flex justify-content-center d-none position-absolute`;
    ...
    setPowerButtonsPosition(block, blockRect, direction) {
        ...
        this.powerButtonsContainer.style.height = blockRect.height + "px";
    }
