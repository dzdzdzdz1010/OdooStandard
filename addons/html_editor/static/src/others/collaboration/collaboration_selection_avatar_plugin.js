...
export class CollaborationSelectionAvatarPlugin extends Plugin {
    ...
    resources = {
        ...
        external_history_step_listeners: this.refreshSelection.bind(this),
        layout_geometry_change_listeners: this.refreshSelection.bind(this),
        set_movable_element_listeners: this.disableAvatarForElement.bind(this),
        unset_movable_element_listeners: this.enableAvatars.bind(this),
