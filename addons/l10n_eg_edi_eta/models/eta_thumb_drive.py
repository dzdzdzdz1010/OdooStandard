...
class L10n_Eg_EdiThumbDrive(models.Model):
    ...
    def set_certificate(self, certificate):
        ...
        """
        self.ensure_one()
        self.certificate = BinaryValue.from_bytes(base64.b64decode(certificate.encode()))
        return True
    ...
    def set_signature_data(self, invoices):
        ...
        for key, value in invoices.items():
            ...
            invoice_id.l10n_eg_eta_json_doc_file = BinaryValue.from_bytes(json.dumps(eta_invoice_json).encode())
