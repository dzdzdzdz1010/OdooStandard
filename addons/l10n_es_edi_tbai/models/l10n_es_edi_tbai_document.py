...
from odoo.tools import BinaryValue, get_lang
    ...
    def _sign_sale_document(self, xml_root):
        ...
        values = {
            'dsig': {
                ...
                'x509_certificate': BinaryValue.from_bytes(base64.b64decode(certificate_sudo._get_der_certificate_bytes())),
                ...
                'sigcertif_digest': BinaryValue.from_bytes(certificate_sudo._get_fingerprint_bytes(formatting='raw')),
