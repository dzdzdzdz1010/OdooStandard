...
class AccountMove(models.Model):
    ...
    def _compute_l10n_fr_pdp_status(self):
        for move in self:
            ...
            if not flows:
                # Not linked to any flow yet -> empty
                move.l10n_fr_pdp_status = False
                continue
            ...
            relevant_flow = active_flows[:1] if active_flows else flows[:1]
            ...
            period_status = relevant_flow.period_status
