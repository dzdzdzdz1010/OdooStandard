...
from odoo.tools import BinaryValue, formatLang, float_round, float_repr, cleanup_xml_node, groupby
...
class AccountMove(models.Model):
    ...
    def _l10n_hu_edi_upload(self, connection):
        ...
        for invoice in invoices_sorted:
            ...
            # Generate XML
            invoice.l10n_hu_edi_attachment = BinaryValue.from_bytes(invoice._l10n_hu_edi_generate_xml())
