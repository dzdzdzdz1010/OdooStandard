...
from odoo.tools import BinaryValue, cleanup_xml_node, float_compare, float_is_zero, float_repr, float_round, html2plaintext
    ...
    def _l10n_it_edi_import_invoice(self, invoice, data, is_new):
        ...
        with self._get_edi_creation() as self:
            ...
            for element in tree.xpath('.//Allegati'):
                ...
                self.l10n_it_edi_attachment_file = BinaryValue.from_bytes(base64.b64decode(get_text(element, './/Attachment')))
