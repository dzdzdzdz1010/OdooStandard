...
def migrate(cr, version):
    ...
    report_lines = [f"l10n_ro.account_tax_report_ro_baza_rd{code}" for code in ["92", "102", "112", "242", "252", "261", "262"]] + [
                    f"l10n_ro.account_tax_report_ro_tva_rd{code}" for code in ["92", "102", "112", "242", "252", "261", "262"]]
