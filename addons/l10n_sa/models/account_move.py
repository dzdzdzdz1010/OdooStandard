...
class AccountMove(models.Model):
    ...
    def _get_normalized_l10n_sa_confirmation_datetime(self, invoice_date, invoice_time=None):
        ...
        if selected_date > now_sa.date():
            raise UserError(_("ZATCA doesn't allow invoicing in the future"))
    ...
    def write(self, vals):
        ...
        for move in self.filtered('l10n_sa_confirmation_datetime'):
            move.l10n_sa_confirmation_datetime = self._get_normalized_l10n_sa_confirmation_datetime(invoice_date, move.l10n_sa_confirmation_datetime.time())
        return result
