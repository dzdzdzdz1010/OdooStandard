...
class AccountJournal(models.Model):
    ...
    def _l10n_sa_generate_csr(self):
        ...
        self.l10n_sa_csr = BinaryValue.from_bytes(self.env['certificate.certificate'].sudo()._l10n_sa_get_csr_bin(self))
    ...
    def _l10n_sa_get_compliance_CSID(self, otp):
        ...
        cert_id = self.env['certificate.certificate'].sudo().create({
            ...
            'content': BinaryValue.from_bytes(b64decode(CCSID_data['binarySecurityToken'])),
    ...
    def _l10n_sa_get_production_CSID(self, OTP=None):
        ...
        pcsid_certificate = self_sudo.env['certificate.certificate'].create({
            ...
            'content': BinaryValue.from_bytes(b64decode(PCSID_data['binarySecurityToken'])),
        })
    ...
    def _l10n_sa_load_edi_test_data(self):
        ...
        self.write({
            ...
            'l10n_sa_csr': BinaryValue.from_bytes(b''),
