...
class TestUBLTRXMLDecode(TestUBLTRCommon):
    ...
    def setUpClass(cls):
        ...
        cls.xml_templates = {
            ...
            'ihracat': 'l10n_tr_nilvera_einvoice/tests/expected_xmls/ihracat_sale.xml',
    ...
    def test_node_name_mapping_is_correct(self):
        ...
        node_name = self.account_edi_xml_ubl_tr._l10n_tr_import_partner_node_name(tree)
    ...
    def test_partner_not_set_if_vkn_missing(self):
        ...
        partner_id = self.account_edi_xml_ubl_tr._l10n_tr_resolve_invoice_partner(
    ...
    def test_no_bank_account_when_payment_means_missing(self):
        ...
        vals = {}
        self.account_edi_xml_ubl_tr._l10n_tr_resolve_bank_account(tree, partner, vals, [])
    ...
    def test_product_resolution_by_ctsp_number(self):
        ...
        vals = {}
        self.account_edi_xml_ubl_tr._l10n_tr_resolve_invoice_lines(tree, vals, 'sale', [])
