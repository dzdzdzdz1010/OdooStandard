...
export class DiscussChannel extends Record {
    ...
    /** @type {"meeting_channel"|undefined} */
    display_name_mode;
    ...
    get displayName() {
        if (this.display_name_mode === "meeting_channel" && this.create_date && !this.name) {
            ...
            return _t("%(meeting)s - %(date)s", { meeting: baseName, date: formatDate });
        }
