...
test("should temporarily repin unpinned thread while it is being viewed", async () => {
    ...
    await start();
    await openDiscuss(subChannelId);
    await contains(".o-mail-DiscussSidebarChannel-subChannel", { count: 2 });
    ...
    await contains(".o-mail-DiscussSidebarChannel-subChannel:text('Sub Channel 2')");
    await click("button[title='Threads']");
    await contains(".o-mail-SubChannelPreview", { count: 2 });
    await click(".o-mail-SubChannelPreview:text('Sub Channel 1')");
    await contains(".o-mail-DiscussSidebarChannel-subChannel", { count: 2 });
