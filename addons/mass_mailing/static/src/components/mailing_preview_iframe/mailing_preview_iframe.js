    ...
    setup() {
        ...
        const updateIframeSize = () => {
            ...
            if (this.state.isMobileMode) {
                ...
                // as modal width is not wide enough to display iframe in desktop mode,
                // we explicitly give desktop width to it.
                const desktopWidth = 1200;
                const containerWidth = document
                    .querySelector(".modal-body")
                    .getBoundingClientRect().width;
                // need to scale down iframe, so that it fits in modal
