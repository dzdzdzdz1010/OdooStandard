...
class MailingMailingTest(models.TransientModel):
    ...
    reply_to = fields.Char(string='Reply To', related='mass_mailing_id.reply_to')
    ...
    def _compute_mailing_preview(self):
        ...
        for record in (self - to_reset):
            ...
            if record.preview_record_ref:
                ...
                composer = self.env['mail.compose.message'].new(composer_values)
    ...
    def send_mail_test(self):
        ...
        valid_emails = []
        invalid_candidates = []
        for candidate in self.email_to.split(','):
