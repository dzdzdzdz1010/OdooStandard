...
class MrpBom(models.Model):
    ...
    def _compute_json_popover(self):
        ...
        for bom in self.filtered(lambda bom: bom.type != 'phantom' and bom._origin):
            ...
            component_info = max(bom_data.get('components'), key=lambda component: component.get('lead_time', 0) or component.get('availability_delay', 0) or component.get('manufacture_delay', 0), default={'lead_time': 0, 'availability_delay': 0, 'manufacture_delay': 0, 'name': ''})
