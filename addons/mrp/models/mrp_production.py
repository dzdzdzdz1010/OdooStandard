    ...
    def _get_consumption_issues(self):
        ...
        for order in self:
            ...
            for move in order.move_raw_ids:
                ...
                # We warn on mismatched quantities and/or UoMs. We need to be careful not to add duplicate warnings
                # if both fields are mismatched or if a zero quantity field has the wrong UoM, which can be ignored.
