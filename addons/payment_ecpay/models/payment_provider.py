...
class PaymentProvider(models.Model):
    ...
    def _ecpay_calculate_signature(self, data):
        ...
        encoding_lst = []
        encoding_lst.append('HashKey=%s&' % self.ecpay_hash_key)
        encoding_lst.append(''.join([f'{key}={value}&' for key, value in ordered_data.items()]))
        encoding_lst.append('HashIV=%s' % self.ecpay_hash_iv)
