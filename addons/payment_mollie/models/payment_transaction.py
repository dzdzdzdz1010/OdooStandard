...
class PaymentTransaction(models.Model):
    ...
    def _mollie_prepare_payment_request_payload(self):
        ...
        if self.token_id:
            ...
            payload['customerId'] = self._mollie_get_or_create_customer()
    ...
    def _extract_token_values(self, payment_data):
        ...
        if not mandate_id:
            _logger.warning(
                "Mollie tokenization aborted: missing mandate_id "
    ...
    def _mollie_get_or_create_customer(self):
        """Create or return a Mollie customer for this partner."""
        partner = self.partner_id

        if existing_customer_id := partner.mollie_customer_id:
        ...
        partner.mollie_customer_id = customer_id
