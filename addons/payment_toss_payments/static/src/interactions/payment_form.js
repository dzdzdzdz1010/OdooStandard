...
patch(PaymentForm.prototype, {
    ...
    async _processDirectFlow(providerCode, paymentOptionId, paymentMethodCode, processingValues) {
        ...
        const partnerPhoneSanitized = this.sanitizedKoreanPhoneNumber(processingValues.partner_phone)
    ...
    /**
     * Returns sanitized phone number that matches the Toss Payments SDK requirements.
     * @param {string} phoneNumber
     * @returns {string} Sanitized phone number, or empty string if the phoneNumber is invalid
     */
    sanitizedKoreanPhoneNumber(phoneNumber) {
