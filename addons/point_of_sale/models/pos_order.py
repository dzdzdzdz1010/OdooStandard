...
class PosOrder(models.Model):
    ...
    def action_pos_order_invoice(self):
        ...
        is_picking_created = self._force_create_picking_real_time()
        self.write({'to_invoice': True})
        if not is_picking_created and self._force_create_picking_real_time() and self.session_id.state != 'closed':
            self._create_order_picking()
