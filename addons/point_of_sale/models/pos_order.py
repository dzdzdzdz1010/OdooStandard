...
class PosOrder(models.Model):
    ...
    def _create_misc_reversal_move(self, payment_moves):
        ...
        lines_to_reconcile = candidate_lines.filtered(
            lambda l: l.account_id in accounts and not l.reconciled
        )
        for account in lines_to_reconcile.account_id:
            lines_to_reconcile.filtered(lambda l: l.account_id == account).reconcile()
