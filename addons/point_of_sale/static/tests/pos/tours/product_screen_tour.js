...
registry.category("web_tour.tours").add("CashClosingDetails", {
    steps: () =>
        [
            ...
            FeedbackScreen.clickNextOrder(),
            ProductScreen.isShown(),
            // Show dialog when closing session with draft orders
            ProductScreen.addOrderline("Desk Organizer", "1"),
            Chrome.clickMenuOption("Close Register"),
            ProductScreen.closeWithCashAmount("51.0"),
            Dialog.confirm("Close Register"),
            {
                trigger: ".modal .btn-primary:contains(Review Orders)",
                run: "click",
            ...
            {
                trigger: ".modal .btn-secondary:contains(Cancel Orders)",
                run: "click",
