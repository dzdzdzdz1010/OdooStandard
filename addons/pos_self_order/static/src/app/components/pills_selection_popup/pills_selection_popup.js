...
import { useScrollToSelected } from "@pos_self_order/app/utils/scroll_to_selected_hook";
...
export class PillsSelectionPopup extends Component {
    ...
    setup() {
        ...
        this.onClickScrollTracked = useScrollToSelected(
    ...
    get isTimeSelection() {
        return this.props.title.includes("hour") || this.props.title.includes("time");
    }

    get isTableSelection() {
        return this.props.title.includes("table");
    }
