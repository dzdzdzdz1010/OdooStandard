...
export class ResourcePopoverService {
...
export const resourcePopoverService = {
    dependencies: ["action", "orm", "view"],
    async start(env, services) {
        return new ResourcePopoverService(env, services);
    },
};

registry.category("services").add("resourcePopoverService", resourcePopoverService);
