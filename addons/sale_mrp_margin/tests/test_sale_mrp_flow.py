...
class TestSaleMrpFlow(test_sale_mrp_flow.TestSaleMrpFlowCommon):
    ...
    def test_kit_cost_calculation(self):
        ...
        self.env['mrp.bom'].browse([component_a_bom.id, super_kit_bom.id]).action_update_product_cost_from_bom()
    ...
    def test_kit_cost_calculation_2(self):
        ...
        self.component_b.standard_price = 10
        self.env['mrp.bom'].browse([sub_kit_bom.id, kit_bom.id]).action_update_product_cost_from_bom()
