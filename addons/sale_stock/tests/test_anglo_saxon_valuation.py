...
class TestAngloSaxonValuation(TestStockValuationCommon):
    ...
    def test_cogs_valued_by_lots(self):
        ...
        self._make_in_move(self.product_avco_auto, 1, 10, lot_ids=[self.lot1])
        self._make_in_move(self.product_avco_auto, 1, 20, lot_ids=[self.lot2])
        self.assertEqual(self.product_avco_auto.standard_price, 15)
