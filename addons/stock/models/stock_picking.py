...
class StockPicking(models.Model):
    ...
    @api.depends('move_line_ids', 'move_line_ids.result_package_id', 'move_line_ids.product_uom_id', 'move_line_ids.quantity', 'move_line_ids.product_id.weight')
    ...
    @api.depends('move_line_ids', 'move_line_ids.result_package_id', 'move_line_ids.product_uom_id', 'move_line_ids.quantity', 'move_line_ids.product_id.volume')
