...
class ProductLabelLayout(models.TransientModel):
    ...
    def _get_zpl_label_placeholder(self):
        return BinaryFile('stock/static/img/zpl_label_placeholder.png')
    ...
    def _prepare_report_data(self):
        ...
        if self.move_quantity == 'move' and self.move_ids and all(ml.uom_id.is_zero(ml.quantity) for ml in self.move_ids.move_line_ids):
