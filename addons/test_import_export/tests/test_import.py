...
from odoo.tools import BinaryFile, BinaryValue, mute_logger, DEFAULT_SERVER_DATE_FORMAT, DEFAULT_SERVER_DATETIME_FORMAT
...
class TestPreview(TransactionCase):
    ...
    def test_xls_success(self):
        file_content = BinaryFile('test_import_export/data/test_import.xls')
        import_wizard = self.env['base_import.import'].create({
            'res_model': 'import.preview',
            'file': file_content,
    ...
    def test_xlsx_success(self):
        file_content = BinaryFile('test_import_export/data/test_import.xlsx')
        import_wizard = self.env['base_import.import'].create({
            'res_model': 'import.preview',
            'file': file_content,
    ...
    def test_ods_success(self):
        file_content = BinaryFile('test_import_export/data/test_import.ods')
        import_wizard = self.env['base_import.import'].create({
            'res_model': 'import.preview',
            'file': file_content,
