...
class TestActivityFlow(TestActivityCommon):
    ...
    def test_activity_edition(self):
        ...
        self.assertEqual(test_activity.summary, todo_activity_type.summary)
        self.assertEqual(test_activity.user_id, todo_activity_type.default_user_id)
        self.assertEqual(test_activity.date_deadline, date.today() + relativedelta(days=todo_activity_type.delay_count))
        self.assertEqual(test_activity.note, todo_activity_type.default_note)
