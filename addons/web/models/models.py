...
from odoo.tools import DEFAULT_SERVER_DATE_FORMAT, DEFAULT_SERVER_DATETIME_FORMAT, BinaryValue, date_utils, get_lang, unique, OrderedSet
...
class ResCompany(models.Model):
    ...
    def _get_asset_style_raw(self) -> BinaryValue:
        ...
        return BinaryValue.from_bytes(company_styles.encode())
