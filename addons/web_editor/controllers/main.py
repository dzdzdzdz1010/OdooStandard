...
class Web_Editor(http.Controller):
    ...
    def get_assets_editor_resources(self, key, get_views=True, get_scss=True, get_js=True, bundles=False, bundles_restriction=[], only_user_custom_files=True):
        ...
        views = request.env["ir.ui.view"].with_context(no_primary_children=True, __views_get_original_hierarchy=[], use_website_lang=True).get_related_views(key, bundles=bundles)
