...
from odoo.tools.translate import should_translate_default_attr
...
class WebsiteHTMLTextProcessor(models.AbstractModel):
    ...
    def _get_translation_term(self, translate_string, xml_string):
        ...
        `USER_ONLY_TRANSLATED_ATTRS` (e.g. `src`).
        ...
        if (
            ...
            and not should_translate_default_attr(translate_string, xml_string)
        ):
            return
