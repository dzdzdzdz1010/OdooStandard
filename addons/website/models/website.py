...
from odoo.tools.binary import BinaryFile, BinaryValue
...
class Website(models.CachedModel):
    ...
    def _default_logo(self):
        return BinaryFile('website/static/src/img/website_logo.svg')
    ...
    def _default_favicon(self):
        return BinaryFile('web/static/img/favicon.ico')
