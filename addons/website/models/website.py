...
from odoo.tools import BinaryValue, SQL
...
class Website(models.CachedModel):
    ...
    def _default_logo(self):
        return BinaryValue.from_file('website/static/src/img/website_logo.svg')
    ...
    def _default_favicon(self):
        return BinaryValue.from_file('web/static/img/favicon.ico')
    ...
    def _handle_favicon(self, vals):
        if icon := vals.get('favicon'):
            vals['favicon'] = BinaryValue.from_bytes(image_process(icon, size=(256, 256), crop='center', output_format='ICO'))
