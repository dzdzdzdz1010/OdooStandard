...
export class ContentWidthOption extends BaseOptionComponent {
    ...
    static exclude =
        "[data-snippet] :not(.oe_structure) > [data-snippet],#footer > *,#o_wblog_post_content *, .s_bento_banner section[data-name='Card'],.s_floating_blocks .s_floating_blocks_block, .s_bento_block_card, .s_blog_post_single_circle";
