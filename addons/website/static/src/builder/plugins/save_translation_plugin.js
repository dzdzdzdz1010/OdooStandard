...
export class SaveTranslationPlugin extends Plugin {
    ...
    async saveDelayTranslations(groupedDirtyElements) {
        ...
        const cleanDelayTranslationEls = this.editable.querySelectorAll(".o_delay_translation:not(.o_dirty)");
        const groupedDelayTranslationElements = this.dependencies.savePlugin.groupElement(
            cleanDelayTranslationEls
        );
        ...
        for (const [key, els] of Object.entries(groupedDelayTranslationElements)) {
            ...
            updateTranslationProms.push(rpc("/website/field/translation/update", {
