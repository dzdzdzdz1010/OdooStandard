...
test("dynamic snippet carousel loads items and displays them through template (desktop)", async () => {
    ...
    expect(prevButton).toHaveClass("d-none");
    ...
    expect(prevButton).not.toHaveClass("d-none");
    ...
    const newItemEls = queryAll(".carousel .s_test_dynamic_carousel_item");
    expect(newItemEls[8]).toHaveAttribute("data-started", "*test9*");
