import { expect, test, before, after } from "@odoo/hoot";
...
<section class="s_whatsapp position-fixed bottom-0">
    ...
    <div class="chatbox bg-white rounded-3 position-absolute shadow-lg overflow-hidden mb-2 d-none">
        ...
        <div class="wa-messages p-2">
            <p class="wa-agent-msg text-break bg-white rounded-3 p-2 m-0 fs-6">Hi there 👋
                <br/>How can I help you?
            </p>
        </div>
        <div class="wa-user-input">
            <!-- Regular input box -->
            <div class="wa-input-box border-top">
                <textarea class="wa-user-message flex-grow-1 p-2 border-0" placeholder="Enter Your Message..." rows="1"></textarea>
                <button class="wa-send border-0 p-2 text-white fs-5">➤</button>
            </div>
            <!-- CTA mode -->
            <div class="wa-cta-box justify-content-center p-2 border-top">
                <button class="wa-cta-btn d-flex align-items-center gap-2 px-5 py-3 fw-semibold rounded-4 shadow-sm border-0 text-white" >
                    <i class="fa fa-whatsapp"></i>Start Conversation
                </button>
            </div>
        </div>
