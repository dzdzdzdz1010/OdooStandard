...
export class ProductPage extends Interaction {
    ...
    dynamicContent = {
        ...
        '.css_attribute_color input': {
            't-on-change': this.onChangeAttribute.bind(this, '.css_attribute_color')
        },
        'label[name="o_wsale_attribute_image_selector"] input': {
            't-on-change': this.onChangeAttribute.bind(this,
                'label[name="o_wsale_attribute_image_selector"]'),
        },
        'label[name="o_wsale_attribute_thumbnail_selector"] input': {
            't-on-change': this.onChangeAttribute.bind(this,
                'label[name="o_wsale_attribute_thumbnail_selector"]'),
        },
     ...
     * @param {String} itemSelector - The CSS selector used to find the group of items to toggle.
     * @param {MouseEvent} ev - The event object.
     */
    onChangeAttribute(itemSelector, ev) {
        ...
        if (attributeValues) {
            ...
            if (combinationChanged) {
                this._changeAttribute(
                    ...
                    '[name="o_wsale_attribute_thumbnail_selector"],' +
                    '.o_variant_pills'
                );
            }
        }
