...
from odoo.tools import BinaryValue, html2plaintext, ormcache
...
class ResCompany(models.CachedModel):
    ...
    def _get_logo(self):
        return BinaryValue.from_file('base/static/img/res_company_logo.png')
    ...
    def _compute_logo_web(self):
        for company in self:
            ...
            company.logo_web = img and BinaryValue.from_bytes(image_process(img.content, size=(180, 0)))
