...
from odoo.tools import BinaryValue, config, file_open
...
class TestHttpStatic(TestHttpStaticCommon):
    ...
    def test_static22_image_field_csp(self):
        ...
        data = BinaryValue.from_bytes(b'<html><body><div>Hello World</div></body></html>')
...
class TestHttpStaticLogo(TestHttpStaticCommon):
    ...
    def setUpClass(cls):
        ...
        cls.gizeh_data_value = BinaryValue.from_bytes(cls.gizeh_data)
