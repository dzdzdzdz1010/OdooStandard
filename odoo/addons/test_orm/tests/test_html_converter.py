...
from odoo.tools import BinaryFile
...
class TestBinaryExport(TestBasicExport):
    def test_image(self):
        ...
        file = BinaryFile('test_orm/tests/test_vectors/image')
        ...
        file = BinaryFile('test_orm/tests/test_vectors/pdf')

        with self.assertRaises(ValueError):
            converter.value_to_html(file, {})

        file = BinaryFile('test_orm/tests/test_vectors/pptx')
