...
class TestRequestRemainingNotEnabled(TestRequestRemainingCommon):
    ...
    def test_requests_b(self):
        ...
        self.assertEqual(
            log_catcher.output,
            [Like('... odoo.tests.common:Request with path /web/concurrent has been ignored during test as it it does not contain the test_cursor cookie or it is expired. '
             '(required "None (request are not enabled)", got "/test_tests/tests/test_common.py:TestRequestRemainingNotEnabled.test_requests_a")')],
        )
...
class TestRequestRemainingStartDuringNext(TestRequestRemainingCommon):
    ...
    def test_requests_b(self):
        ...
        self.assertEqual(
            log_catcher.output,
            [Like('... odoo.tests.common:Request with path /web/concurrent has been ignored during test as it it does not contain the test_cursor cookie or it is expired. '
             '(required "/test_tests/tests/test_common.py:TestRequestRemainingStartDuringNext.test_requests_b__0", got "/test_tests/tests/test_common.py:TestRequestRemainingStartDuringNext.test_requests_a")')],
        )
...
class TestRequestRemainingAfterFirstCheck(TestRequestRemainingCommon):
    ...
    def test_requests_b(self):
        ...
        self.assertEqual(
            log_catcher.output,
            [Like('... Trying to open a test cursor for /test_tests/tests/test_common.py:TestRequestRemainingAfterFirstCheck.test_requests_a while already in a test /test_tests/tests/test_common.py:TestRequestRemainingAfterFirstCheck.test_requests_b')],
        )
